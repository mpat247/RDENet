...
from RDECNN import RDENet  # Ensure this is correctly imported from your project
...
class FashionMNIST_RDECNNClassifier:
    def __init__(self, batch_size=64, lr=1e-3, epochs=100, patience=10, device=None, save_path='./models/RDECNN'):
    ...
    def test_model(self, model, loader, scenario):
        ...
        # Save test results
        result_path = os.path.join('rdencnn_results', f"{scenario}_test_results.txt")
...
def main():
    # Create rdencnn_results directory
    results_dir = 'rdencnn_results'
    ...
    classifier = FashionMNIST_RDECNNClassifier(batch_size=64, lr=1e-3, epochs=50, patience=10)
